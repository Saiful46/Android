...
public class ActivityWU extends AppCompatActivity {
                        ...
                        try {
                            if(pic != null)
                            {
                                ...
                                if(!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWU.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                {
                                    Intent intent = new Intent(ActivityWU.this, ActivityLoad.class);
                                    startActivity(intent);


                                }
                                else {
                                    Intent intent = new Intent(ActivityWU.this, ActivityLoad2.class);
                                    startActivity(intent);
