...
public class ActivityAlphabetW extends AppCompatActivity {
                        ...
                        try {
                            if(pic != null)
                            {
                                ...
                                if(!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityAlphabetW.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                {
                                    Intent intent = new Intent(ActivityAlphabetW.this, ActivityLoad.class);
                                    startActivity(intent);


                                }
                                else {
                                    Intent intent = new Intent(ActivityAlphabetW.this, ActivityLoad2.class);
                                    startActivity(intent);
