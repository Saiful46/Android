...
public class ActivityWW_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww_a);
                        ...
                        try {
                            if(pic != null)
                            {
                                ...
                                if(!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWW_A.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                // saveScreenShot(pic);
                                if (str.equals("APPLE") || str.equals("Apple"))
                                {
                                    Intent intent = new Intent(ActivityWW_A.this, ActivityLoad.class);
                                    startActivity(intent);


                                }
                                else {
                                    Intent intent = new Intent(ActivityWW_A.this, ActivityLoad2.class);
                                    startActivity(intent);
