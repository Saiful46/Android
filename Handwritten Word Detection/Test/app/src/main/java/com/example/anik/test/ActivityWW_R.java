...
public class ActivityWW_R extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww__r);
                        ...
                        try {
                            if (pic != null) {
                                ...
                                if (!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWW_R.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                // saveScreenShot(pic);
                                if (str.equals("RAT") || str.equals("Rat")) {
                                    Intent intent = new Intent(ActivityWW_R.this, ActivityLoad.class);
                                    startActivity(intent);


                                } else {
                                    Intent intent = new Intent(ActivityWW_R.this, ActivityLoad2.class);
                                    startActivity(intent);
