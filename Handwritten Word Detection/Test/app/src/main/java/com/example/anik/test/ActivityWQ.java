...
public class ActivityWQ extends AppCompatActivity {
                        ...
                        try {
                            if(pic != null)
                            {
                                ...
                                if(!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWQ.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                {
                                    Intent intent = new Intent(ActivityWQ.this, ActivityLoad.class);
                                    startActivity(intent);


                                }
                                else {
                                    Intent intent = new Intent(ActivityWQ.this, ActivityLoad2.class);
                                    startActivity(intent);
