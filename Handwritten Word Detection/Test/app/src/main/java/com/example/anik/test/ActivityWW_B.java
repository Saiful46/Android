...
public class ActivityWW_B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww__b);
        ...
        Okwa1 = (Button) findViewById(R.id.Okwa2);
                        ...
                        try {
                            if (pic != null) {
                                ...
                                if (!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWW_B.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                // saveScreenShot(pic);
                                if (str.equals("BALL") || str.equals("Ball")) {
                                    Intent intent = new Intent(ActivityWW_B.this, ActivityLoad.class);
                                    startActivity(intent);


                                } else {
                                    Intent intent = new Intent(ActivityWW_B.this, ActivityLoad2.class);
                                    startActivity(intent);
