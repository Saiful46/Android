...
public class ActivityWT extends AppCompatActivity {
                        ...
                        try {
                            if(pic != null)
                            {
                                ...
                                if(!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWT.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                {
                                    Intent intent = new Intent(ActivityWT.this, ActivityLoad.class);
                                    startActivity(intent);


                                }
                                else {
                                    Intent intent = new Intent(ActivityWT.this, ActivityLoad2.class);
                                    startActivity(intent);
