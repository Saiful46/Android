...
public class ActivityWW_J extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww__j);
                        ...
                        try {
                            if (pic != null) {
                                ...
                                if (!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWW_J.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                // saveScreenShot(pic);
                                if (str.equals("JUG") || str.equals("Jug")) {
                                    Intent intent = new Intent(ActivityWW_J.this, ActivityLoad.class);
                                    startActivity(intent);


                                } else {
                                    Intent intent = new Intent(ActivityWW_J.this, ActivityLoad2.class);
                                    startActivity(intent);
