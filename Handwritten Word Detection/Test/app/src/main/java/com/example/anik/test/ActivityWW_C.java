...
public class ActivityWW_C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww__c);
                        ...
                        try {
                            if (pic != null) {
                                ...
                                if (!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWW_C.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                if (str.equals("CAT") || str.equals("Cat")) {
                                    Intent intent = new Intent(ActivityWW_C.this, ActivityLoad.class);
                                    startActivity(intent);


                                } else {
                                    Intent intent = new Intent(ActivityWW_C.this, ActivityLoad2.class);
                                    startActivity(intent);
