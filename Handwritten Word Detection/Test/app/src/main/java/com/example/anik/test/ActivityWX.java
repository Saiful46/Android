...
public class ActivityWX extends AppCompatActivity {
                        ...
                        try {
                            if(pic != null)
                            {
                                ...
                                if(!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWX.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                {
                                    Intent intent = new Intent(ActivityWX.this, ActivityLoad.class);
                                    startActivity(intent);


                                }
                                else {
                                    Intent intent = new Intent(ActivityWX.this, ActivityLoad2.class);
                                    startActivity(intent);
