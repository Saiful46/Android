...
public class ActivityWW_Z extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww__z);
                        ...
                        try {
                            if (pic != null) {
                                ...
                                if (!textRecognizer.isOperational())
                                    ...
                                    Toast.makeText(ActivityWW_Z.this, stringBuilder.toString(), Toast.LENGTH_SHORT).show();
                                ...
                                // saveScreenShot(pic);
                                if (str.equals("ZEBRA") || str.equals("Zebra")) {
                                    Intent intent = new Intent(ActivityWW_Z.this, ActivityLoad.class);
                                    startActivity(intent);


                                } else {
                                    Intent intent = new Intent(ActivityWW_Z.this, ActivityLoad2.class);
                                    startActivity(intent);
